const Footer = () => {
  return (
    <footer className="bg-neutral-900 text-neutral-content">
      <div className="max-w-7xl mx-auto px-6 py-4 pt-6">

        <div className="flex flex-col sm:flex-row justify-between items-center sm:items-start gap-8">

          {/* Left Section */}
          <aside className="flex flex-col items-center sm:items-start text-center sm:text-left gap-3">
            <svg
              width="50"
              height="50"
              viewBox="0 0 24 24"
